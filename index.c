...
void admin()
{
    ...
    if(strcmp(uname,"JAHID")==0&&strcmp(pass,"jahid")==0) c=1;//if user name and passpord matches, the value of c is changed from 0 to 1. The purpose of changing value of c is seen @line 77 where the password is asked again if c!=0 i.e. if given password is invalid
    else
    {
        title();
        gotoxy(25,10); printf("Invalid User name or Password!\a");
...
void welcome()
{
    ...
    gotoxy(33,11); printf("PROGRAMMER JAIHD");
    gotoxy(24,20);
